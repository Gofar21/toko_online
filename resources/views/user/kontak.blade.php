...
<style>
    ...
    .test{
        background-image: url('{{ asset('public/shopper') }}/images/bg1.png');
...
<div class="site-section test">
    ...
    <div class="row">
        ...
        <div class="col-md-7 border-shadow" style="border: 1px solid rgb(255, 255, 255); ">
            ...
            <img src="{{ asset('public/shopper') }}/images/celana.jpeg " class="imgpromo">
            <img src="{{ asset('public/shopper') }}/images/celana1.jpeg " class="imgpromo">

        
        </div>
        <div class="col-md-5 ml-auto">
            <div class="p-4 border mb-3">
                <img src="{{ asset('public/shopper') }}/images/contact.png " class="imgpromo">
